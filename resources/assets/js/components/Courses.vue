<template>
    <div>
        <div class="alert alert-primary text-center" v-if="processing"><i class="fas fa-compass"> Procesando peticion...</i></div>
        <v-server-table ref="table" :columns="columns" :url="url" :options="options">
            ...
            <div slot="activate_deactivate" slot-scope="props">
                ...
                >
                    <i class="fas fa-rocket"></i> {{ labels.approve }}
                </button>
            </div>
...
<style scoped>
    .table-bordered>thead>tr>th, .table-bordered>thead>tr>td, .table-bordered>tbody>tr>th, .table-bordered>tr>td, .table-bordered>tfoot>tr>th, .table-bordered>tfoot>tr>td {
